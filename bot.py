...
def in_target_channel(member: discord.Member) -> bool:
    """يتأكد إن العضو جالس بنفس الروم الصوتي المخصص لهذا البوت."""
...
# ------------------------------------------------------------------
# المفضلة (تخزين بسيط بملف JSON محلي لهذا البوت)
# ------------------------------------------------------------------
def _load_favorites():
...
# ------------------------------------------------------------------
# استخراج بيانات الفيديو من يوتيوب
# ------------------------------------------------------------------
...
class MusicControls(discord.ui.View):
    ...
    # ---- الصف الأول: تكرار / فوليوم+ / تشغيل-إيقاف / فوليوم- / مفضلة ----
...
async def on_message(message: discord.Message):
    ...
    # أمر عرض المفضلة متاح من أي مكان (لا يحتاج تواجد بروم معين)
    if content == "مفضلتي":
